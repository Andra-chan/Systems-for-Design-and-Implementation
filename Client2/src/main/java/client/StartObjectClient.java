...
import project.network.objectprotocol.ServicesObjectProxy;
...
public class StartObjectClient extends Application {
    ...
    public static void changeSceneToMainWindow(User user, IServices service) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(StartObjectClient.class.getClassLoader().getResource("mainPage.fxml"));
    ...
    public static void changeSceneToLogin(IServices service) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(StartObjectClient.class.getClassLoader().getResource("login.fxml"));
    ...
    public void start(Stage stage) throws Exception {
        ...
        FXMLLoader mainPageLoader = new FXMLLoader(StartObjectClient.class.getClassLoader().getResource("mainPage.fxml"));
