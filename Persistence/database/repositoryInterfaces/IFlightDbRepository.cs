...
namespace Persistence.database.repositoryInterfaces
{
    ...
    public interface IFlightDbRepository<ID, E>
    {
        ...
        IList<E> findBySearch(String searchDestination, DateTime searchDateTime);

        IList<E> findBySearchAirport(String searchDestination, String searchAirport);
